...
class SaveDirectExpense
{
    ...
    public function __construct(array $dataArray = [])
    {
        ...
        $this->chartaccount_dal_id = Utils::getValueOrNull($dataArray, 'chartaccount_dal_id');
    ...
    /**
     * @param int $chartaccount_dal_id
     */
    public function setChartAccountDalId($chartaccount_dal_id)
    {
        $this->chartaccount_dal_id = $chartaccount_dal_id;
    }
    ...
    public function toArray()
    {
        $array = array('variable_symbol' => $this->variableSymbol,
            ...
            'chartaccount_dal_id' => $this->chartaccount_dal_id,
        );
        $array['items'] = array();
